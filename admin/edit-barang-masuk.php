...
{ 
  ...
  // update user data
  $result = mysqli_query($koneksi, "UPDATE barang_masuk SET serial_number='$kode',nama_barang='$name',tanggal='$tanggal',pengirim='$pengirim',penerima='$penerima' WHERE id=$id");
  $result2 = mysqli_query($koneksi, "UPDATE gudang SET serial_number='$kode',nama_barang='$name',tanggal='$tanggal',pengirim='$pengirim',penerima='$penerima' WHERE id=$id");
				...
				<form action="" method="post" name="form1">
					<div class="col s12 m12 l12 card-panel z-depth"> <br>
						<table class="highlight">
							...
							<tr>
					        	<td>Serial Number</td>
					        	<td><input type="text" name="serial_number" value=<?php echo $kode; ?>></td>
					      	</tr>
					      	<tr> 
					        	<td>Nama Barang</td>
