	...
	<div class="row">
				...
				<form action="" method="post" name="form1">
					<div class="col s12 m12 l12 card-panel z-depth"> <br>
						<table class="highlight">
				            ...
				            <tr>
				              <th>Jenis Kelamin</th>
				              <th><input type="text" name="jenis_kelamin" required></th>
				            </tr>
				            <tr>
				              <th>Username</th>
				            ...
				            <tr>
				              <th>Level</th>
				              <th>
				                <input type="text" name="level" placeholder="Isi Dengan Admin / Kacab">
				              </th>
				            </tr>
						</table>
						<table>
        ...
        <?php
          ...
          if(isset($_POST['tambah'])) {
            ...
            $result = mysqli_query($koneksi, "INSERT INTO users(nik,nama,alamat,telepon,divisi,jenis_kelamin,username,password,level) VALUES('$nik','$name','$alamat','$telepon','$divisi','$jenis_kelamin','$username','$password','$level')");
