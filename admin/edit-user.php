...
{ 
  ...
  // update user data
  $result = mysqli_query($koneksi, "UPDATE users SET nik='$nik',nama='$name',alamat='$alamat',telepon='$mobile',divisi='$divisi',jenis_kelamin='$jenis_kelamin',level='$level' WHERE id=$id");
