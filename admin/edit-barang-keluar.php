...
{ 
  ...
  // update user data
  $result = mysqli_query($koneksi, "UPDATE barang_keluar SET serial_number='$kode',nama_barang='$name',tanggal='$tanggal',tujuan='$pengirim',operator='$operator' WHERE id=$id");
