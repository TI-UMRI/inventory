...
$result = mysqli_query($koneksi, "SELECT * FROM barang_keluar ORDER BY serial_number DESC");
	...
	<div class="row">
        ...
        <?php
          ...
          if(isset($_POST['tambah'])) {
            ...
            $result = mysqli_query($koneksi, "INSERT INTO barang_keluar(serial_number,nama_barang,tujuan,tanggal,operator) VALUES('$serial_number','$name','$tujuan','$tanggal','$operator')");
            $result2 = mysqli_query($koneksi, "DELETE FROM gudang WHERE serial_number=$serial_number"); 
            
            echo "<script>alert('Tambah Barang Keluar Berhasil ! Serial Number : $serial_number') </script>";
          }
        ?>
