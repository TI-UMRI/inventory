...
$result = mysqli_query($koneksi, "SELECT * FROM barang_masuk ORDER BY serial_number DESC"); 
$result2 = mysqli_query($koneksi, "SELECT * FROM gudang ORDER BY serial_number DESC"); 
	...
	<div class="row">
				...
				<form action="" method="post" name="form1">
					<div class="col s12 m12 l12 card-panel z-depth"> <br>
						<table class="highlight">
							...
							<tr>
				              <th>Serial Number</th>
				              <th><input type="text" name="serial_number" required></th>
				            </tr>
			              	<tr>
			                	<th>Nama Barang</th>
        ...
        <?php
          ...
          if(isset($_POST['tambah'])) {
            ...
            $result = mysqli_query($koneksi, "INSERT INTO barang_masuk(serial_number,nama_barang,pengirim,tanggal,penerima) VALUES('$serial_number','$name','$pengirim','$tanggal','$penerima')"); 
            $result2 = mysqli_query($koneksi, "INSERT INTO gudang(serial_number,nama_barang,pengirim,tanggal,penerima) VALUES('$serial_number','$name','$pengirim','$tanggal','$penerima')"); 
            
            echo "<script>alert('Tambah Barang Berhasil ! Serial Number : $serial_number')</script>";
          }
        ?>
